...
/{{ cookiecutter.project_name }}/app/manage.py migrate
...
if [[ "$ENVIRONMENT" = "production" ]]; then
    ...
    /{{ cookiecutter.project_name }}/app/manage.py collectstatic --noinput
    chown -R appuser:appuser /{{ cookiecutter.project_name }}/app

    # Run uwsgi
    uwsgi --ini /{{ cookiecutter.project_name }}/uwsgi.ini
fi
