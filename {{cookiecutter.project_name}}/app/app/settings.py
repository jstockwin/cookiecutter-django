...
from app.pipeline import get_assets_pipeline
...
if os.path.exists(".secrets"):
    ...
    CONFIG_PARSER.read_file(open(".secrets"))

# Quick-start development settings - unsuitable for production
# See https://docs.djangoproject.com/en/3.0/howto/deployment/checklist/

# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = os.environ.get("SECRET_KEY", CONFIG_PARSER.get("default", "SECRET_KEY"))
...
PIPELINE_STORAGE = "pipeline.storage.PipelineManifestStorage"
...
{% if cookiecutter.email_settings %}
# Emails
